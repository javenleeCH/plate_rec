...
__C.YOLO.CLASSES = "./plate.names"
# __C.YOLO.ANCHORS = "./data/anchors/yolo_anchors_gray.txt"
...
# __C.TRAIN.ANNOT_PATH = "./data/dataset/datasetnew_gray_train.txt"
# # __C.TRAIN.BATCH_SIZE            = 6
# __C.TRAIN.BATCH_SIZE = 2
# __C.TRAIN.INPUT_SIZE = [256, 288, 320, 352, 384, 416, 448, 480, 512, 544, 576, 608]
...
# #__C.TRAIN.INITIAL_WEIGHT = "./checkpoint/yolov3_test1_loss=0.5687.ckpt-1"


# # TEST options
# __C.TEST = edict()

# __C.TEST.ANNOT_PATH = "./data/dataset/datasetnew_gray_test.txt"
